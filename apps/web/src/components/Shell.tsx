...
import { Activity, Boxes, ChartNoAxesCombined, ClipboardCheck, CreditCard, LayoutDashboard, Menu, PackagePlus, Settings, ShoppingCart, Users, Wallet } from 'lucide-react';
