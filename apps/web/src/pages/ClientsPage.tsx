...
export function ClientsPage() {
  ...
  return <>
    ...
    <section className="panel list-panel clients-panel">
      ...
      <div className="table-wrap desktop-record-table"><table className="clients-table"><thead><tr><th>Cliente</th><th>Identificación</th><th>Teléfono</th><th>Estado</th><th className="number-cell">Préstamos activos / vencidos</th><th className="number-cell">Capital pendiente</th><th>Acciones</th></tr></thead><tbody>
