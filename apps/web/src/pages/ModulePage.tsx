...
const configs: Record<string, Config> = {
  ...
  compras: { title: 'Compras', subtitle: 'Registra el inventario adquirido y su costo final.', resource: '/compras', action: 'Registrar compra', columns: [['fecha', 'Fecha'], ['total', 'Total'], ['estado', 'Estado']], stage: 'La confirmación de compras y el movimiento de fondos están habilitados.' },
